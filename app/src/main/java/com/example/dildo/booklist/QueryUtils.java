        ...
        try {
            ...
            if (baseJsonResponse.has("items")) {
                ...
                for (int i = 0; i < bookArray.length(); i++) {
                    ...
                    JSONObject priceInfo = currentBook.getJSONObject("saleInfo");
                    ...
                    double price;
                    if (priceInfo.has("listPrice")) {
                        price = priceInfo.getJSONObject("listPrice").getDouble("amount");
                    } else price = 0.00;
                    ...
                    Book book = new Book(rating, title, authors, description, price);
